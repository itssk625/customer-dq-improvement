...
def calculate_metrics():
    ...
    invalid_dob_pct= (invalid_dob_counts/total)*100
    ...
    invalid_phoneno_pct=(invalid_phoneno_counts/total)*100
    ...
    invalid_country_pct= (invalid_country_counts/total)*100
    ...
    invalid_email_pct=(invalid_email_counts/total)*100
